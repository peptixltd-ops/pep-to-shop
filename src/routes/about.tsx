...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      { title: "About — Pondok" },
      { name: "description", content: "Pondok makes premium UK supplements built on purity, consistency and trust." },
      { property: "og:title", content: "About Pondok" },
  ...
  return (
    <div>
      ...
      <section className="grid lg:grid-cols-2">
        <img src={bottles} alt="Pondok bottles" loading="lazy" width={1280} height={896} className="w-full h-full object-cover aspect-[4/3] lg:aspect-auto" />
        <div className="bg-mist p-10 lg:p-20 flex flex-col justify-center space-y-5 text-foreground/80">
          ...
          <p>Pondok exists to make premium wellness supplements straightforward — clean formulations, honest labelling, fast delivery.</p>
