...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Pondok Peptides makes premium UK supplements built on purity, consistency and trust." },
    ...
    <div>
      ...
      <section className="grid lg:grid-cols-2">
        ...
        <div className="bg-mist p-10 lg:p-20 flex flex-col justify-center space-y-5 text-foreground/80">
          ...
          <p>Pondok Peptides exists to make premium wellness supplements straightforward — clean formulations, honest labelling, fast delivery.</p>
